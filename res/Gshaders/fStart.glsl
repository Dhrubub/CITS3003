...
void main()
{
	...
	xDir3 = clamp(-LightPosition2.x, -3.0, 3.0);
	yDir3 = clamp(-LightPosition2.y, -3.0, 3.0);
	zDir3 = clamp(-LightPosition2.z, -3.0, 3.0);
	...
	if(theta > angleCutOff) {
		...
		vec3 colorLight3 = ambient3 + diffuse3 + specular3;
	}
	else {
